export const fundingPrograms = [
  ...
  // KfW & Bundesförderung
  {
    name: "KfW 208 - Investitionskredit Kommunen",
    type: ["playground", "calisthenics", "combination"],
    federalStates: ["all"],
    measures: ["newBuild", "renovation", "accessibility", "greening"],
    fundingRate: "Zinsgünstiges Darlehen",
    source: "https://www.kfw.de/inlandsfoerderung/Öffentliche-Einrichtungen/Kommunen/Förderprodukte/Investitionskredit-Kommunen-(208)/",
    description: "Zinsgünstiger Kredit für kommunale Investitionen"
  },
  {
    name: "KfW 432 - Energetische Stadtsanierung",
    type: ["playground", "combination"],
    federalStates: ["all"],
    measures: ["renovation", "greening"],
    fundingRate: "Zinsgünstiges Darlehen",
    source: "https://www.kfw.de/inlandsfoerderung/Öffentliche-Einrichtungen/Kommunale-soziale-Unternehmen/Förderprodukte/Energetische-Stadtsanierung-Kommunen-(432)/",
    description: "Förderung energieeffizienter Quartierskonzepte"
  },
  {
  ...
  {
    name: "Nationale Klimaschutzinitiative (NKI)",
    type: ["playground", "combination"],
    federalStates: ["all"],
    measures: ["greening", "newBuild"],
    fundingRate: "40-70%",
    source: "https://www.klimaschutz.de/de/foerderung",
    description: "Klimaschutzprojekte im kommunalen Umfeld"
  },
  ...
  // Sport Bund
  {
    name: "Sportstättenförderung (Goldener Plan)",
    type: ["calisthenics", "combination"],
    federalStates: ["all"],
    measures: ["newBuild", "renovation", "accessibility"],
    fundingRate: "30-50%",
    source: "https://www.dosb.de/sportentwicklung/sportstaetten",
    description: "Bundesweite Förderung von Sportstätten und Bewegungsräumen"
  },
  
  // Sonstige Bundesförderung
  {
    ...
    source: "https://www.foerderdatenbank.de/",
    description: "Zentrale Übersicht über Förderprogramme von Bund, Ländern und EU"
  },
  {
    name: "Gemeindeverkehrsfinanzierungsgesetz (GVFG)",
    type: ["playground", "combination"],
    federalStates: ["all"],
    measures: ["newBuild", "accessibility"],
    fundingRate: "60-75%",
    source: "https://www.bmvi.de/SharedDocs/DE/Artikel/StV/Strassenverkehr/gvfg.html",
    description: "Förderung verkehrlicher Infrastruktur inkl. Grünflächen"
  },
  ...
  {
    name: "Berliner Programm für Nachhaltige Entwicklung (BENE 2)",
    type: ["playground", "combination"],
    federalStates: ["BE"],
    measures: ["greening", "newBuild"],
    fundingRate: "variabel",
    source: "https://www.berlin.de/sen/uvk/umwelt/foerderprogramme/bene/",
    description: "Nachhaltigkeitsförderung in Berlin"
  },
  {
  ...
  {
    name: "Dorferneuerung Rheinland-Pfalz (privat)",
    type: ["playground", "calisthenics"],
    federalStates: ["RP"],
    measures: ["renovation", "accessibility"],
    fundingRate: "bis 30%",
    source: "https://www.rlp.de/",
    description: "Private Vorhaben in der Dorferneuerung"
  },
  {
  ...
  {
    name: "CLLD Sachsen-Anhalt",
    type: ["playground", "calisthenics", "combination"],
    federalStates: ["ST"],
    measures: ["newBuild", "renovation", "accessibility"],
    fundingRate: "50-80%",
    source: "https://www.ib-sachsen-anhalt.de/",
    description: "Community-Led Local Development"
  },
  {
  ...
  {
    name: "ELAISA - Investitionsförderung Sachsen-Anhalt",
    type: ["playground", "calisthenics", "combination"],
    federalStates: ["ST"],
    measures: ["newBuild", "renovation"],
    fundingRate: "variabel",
    source: "https://www.ib-sachsen-anhalt.de/",
    description: "Elektronischer Agrarantrag für Investitionsförderung"
  },
  {
  ...
  {
    name: "BINGO! Die Umweltlotterie Schleswig-Holstein",
    type: ["playground", "combination"],
    federalStates: ["SH"],
    measures: ["greening", "newBuild"],
    fundingRate: "variabel",
    source: "https://www.bingo-umweltlotterie.de/",
    description: "Projektförderung für Umwelt und Natur"
  },
  {
